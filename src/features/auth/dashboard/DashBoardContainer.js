...
const DashBoardContainer = () => {
    ...
    if (!users?.length || !employees?.length || !customers?.length || !repairOrders?.length || !repairRequests?.length || !invoices?.length) return <PulseLoader color="#81AFDD" style={{margin: '0em 0em 0em 5em'}} />

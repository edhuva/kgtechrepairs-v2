...
import { faRightFromBracket, faFileCirclePlus, faFilePen,
     faUserGear, faUserPlus } from "@fortawesome/free-solid-svg-icons";
                ...
                <div className='dash-header__container'>
                    <div className='dash-header__container'>
                        <Link to='/dash' className='dash-header__logo'>
                            ...
                            <h1 className="dash-header__title">KGTech Notes</h1>
                        </Link>
                    </div>
                    <div className={`dash-header__container-nav ${dashClass}`}>
